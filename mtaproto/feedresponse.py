from mtaproto import combined_gtfs_pb2
from pytz import timezone
import datetime

TZ = timezone('US/Eastern')

class AlertFeedResponse(object):
    def __init__(self, response_string):
        self._pb_data = combined_gtfs_pb2.gtfs__realtime__pb2.FeedMessage()
...
class Trip(object):
    ...
    def _direction(self):
        trip_meta = self._pb_data.trip_update.trip.Extensions[combined_gtfs_pb2.nyct_trip_descriptor]
        return combined_gtfs_pb2.NyctTripDescriptor.Direction.Name(trip_meta.direction)
